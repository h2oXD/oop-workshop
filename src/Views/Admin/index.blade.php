                        ...
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <h3 class="m-0">Thông kê</h3>
                                </div>
                            </div>
                        </div>
                        <div class="white_card_body" style="height: 286px;">
                            <h2>Thông kê bài biết </h2>
                            <table class="table">
                                <tr>
                                    <th>Danh mục</th>
                                    <th>Số lượng bài</th>
                                ...
                                <div class="header_more_tool">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="assets/admin/#"> <i class="ti-eye"></i>
                                                Action</a>
                                            <a class="dropdown-item" href="assets/admin/#"> <i class="ti-trash"></i>
                                                Delete</a>
                                            <a class="dropdown-item" href="assets/admin/#"> <i class="fas fa-edit"></i>
                                                Edit</a>
                                            <a class="dropdown-item" href="assets/admin/#"> <i class="ti-printer"></i>
                                                Print</a>
                                ...
                                <div class="header_more_tool">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right"
                                            ...
                                            <a class="dropdown-item" href="assets/admin/#"> <i class="ti-printer"></i>
                                                Print</a>
                                            <a class="dropdown-item" href="assets/admin/#"> <i
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="assets/admin/img/customers/1.png" alt></div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="assets/admin/img/customers/2.png" alt></div>
                                                    <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                                </div>
                                            </td>
                                            <td class="f_s_14 f_w_400 color_text_2">Sunglass</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="assets/admin/img/customers/3.png" alt></div>
                                                    <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                                </div>
                                            </td>
                                            <td class="f_s_14 f_w_400 color_text_2">Sunglass</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="assets/admin/img/customers/4.png" alt></div>
                                                    <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                                </div>
                                            </td>
                                            <td class="f_s_14 f_w_400 color_text_2">Sunglass</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="assets/admin/img/customers/5.png" alt></div>
                                                    <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                                </div>
                                            </td>
                                            <td class="f_s_14 f_w_400 color_text_2">Sunglass</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                                            src="assets/admin/img/customers/6.png" alt></div>
                                                    <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                                </div>
                                            </td>
                                            <td class="f_s_14 f_w_400 color_text_2">Sunglass</td>
