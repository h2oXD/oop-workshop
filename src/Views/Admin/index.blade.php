                ...
                <div class="page_title_box d-flex align-items-center justify-content-between">
                    <div class="page_title_left">
                        ...
                        <ol class="breadcrumb page_bradcam mb-0">
                            <li class="breadcrumb-item"><a href="assets/admin/javascript:void(0);">Salessa </a></li>
                            <li class="breadcrumb-item"><a href="assets/admin/javascript:void(0);">Dashboard</a></li>
                            <li class="breadcrumb-item active">Sales</li>
                        </ol>
                    </div>
                    <a href="assets/admin/#" class="white_btn3">Create Report</a>
                </div>
            </div>
        </div>
        <div class="row ">
                    ...
                    <div class="white_card_header">
                        <div class="box_header m-0">
                            ...
                            <div class="float-lg-right float-none sales_renew_btns justify-content-end">
                                <ul class="nav">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="assets/admin/#">This Week</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="assets/admin/#">Last Week</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link" href="assets/admin/#">Last Month</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="white_card mb_20">
                    <div
                        ...
                        <div class="create_report_btn">
                            <a href="assets/admin/#" class="btn_1 mt-1 mb-1">Create Report</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="header_more_tool">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right"
                                        ...
                                        <a class="dropdown-item" href="assets/admin/#"> <i class="ti-eye"></i> Action</a>
                                        <a class="dropdown-item" href="assets/admin/#"> <i class="ti-trash"></i> Delete</a>
                                        <a class="dropdown-item" href="assets/admin/#"> <i class="fas fa-edit"></i> Edit</a>
                                        <a class="dropdown-item" href="assets/admin/#"> <i class="ti-printer"></i> Print</a>
                                        <a class="dropdown-item" href="assets/admin/#"> <i class="fa fa-download"></i>
                                            Download</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="white_card_header">
                        <div class="box_header m-0">
                            ...
                            <div class="float-lg-right float-none sales_renew_btns justify-content-end">
                                <ul class="nav">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="assets/admin/#">Today</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="assets/admin/#">This week</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table bayer_table m-0">
                                <tbody>
                                    <tr>
                                        <td>
                                            <img class="byder_thumb wh_56" src="assets/admin/img/Payment/1.png" alt>
                                        </td>
                                        <td>
                    ...
                    <div class="white_card_body">
                        ...
                        <div class="load_more_button text-center mt_30">
                            <a class="theme_text_btn d-flex align-items-center justify-content-center"
                                href="assets/admin/#">Load more <i class="ti-angle-down f_s_12 ms-2"></i> </a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="total_blance mt_20 mb_10">
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <a class="badge_btn_5" href="assets/admin/#">+1235</a>
                                    </div>
                                    <div>
                                        <div><a class="badge_btn_6 mb_15" href="assets/admin/#">Today</a></div>
                                        <div><a class="badge_btn_7" href="assets/admin/#">This week</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table lms_table_active2 p-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0"><img
                                                        class="img-fluid radius_50" src="assets/admin/img/customers/1.png"
                                                        alt></div>
                                        ...
                                        <td class="f_s_14 f_w_400 text-end"><a href="assets/admin/#"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0"><img
                                                        class="img-fluid radius_50" src="assets/admin/img/customers/2.png"
                                                        alt></div>
                                                <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0"><img
                                                        class="img-fluid radius_50" src="assets/admin/img/customers/3.png"
                                                        alt></div>
                                                <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0"><img
                                                        class="img-fluid radius_50" src="assets/admin/img/customers/4.png"
                                                        alt></div>
                                                <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0"><img
                                                        class="img-fluid radius_50" src="assets/admin/img/customers/5.png"
                                                        alt></div>
                                                <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0"><img
                                                        class="img-fluid radius_50" src="assets/admin/img/customers/6.png"
                                                        alt></div>
                                                <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0"><img
                                                        ...
                                                        src="assets/admin/img/customers/pro_1.png" alt></div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0"><img
                                                        class="img-fluid radius_50"
                                                        src="assets/admin/img/customers/pro_2.png" alt></div>
                                                <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                            </div>
                                        </td>
                                        <td class="f_s_14 f_w_400 color_text_2">$564</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0"><img
                                                        class="img-fluid radius_50"
                                                        src="assets/admin/img/customers/pro_3.png" alt></div>
                                                <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                            </div>
                                        </td>
                                        <td class="f_s_14 f_w_400 color_text_2">$564</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0"><img
                                                        class="img-fluid radius_50"
                                                        src="assets/admin/img/customers/pro_4.png" alt></div>
                                                <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                            </div>
                                        </td>
                                        <td class="f_s_14 f_w_400 color_text_2">$564</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0"><img
                                                        class="img-fluid radius_50"
                                                        src="assets/admin/img/customers/pro_5.png" alt></div>
                                                <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                            </div>
                                        </td>
                                        <td class="f_s_14 f_w_400 color_text_2">$564</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_34 mr_15 mt-0"><img
                                                        class="img-fluid radius_50"
                                                        src="assets/admin/img/customers/pro_6.png" alt></div>
                                                <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                                            </div>
                                        </td>
                                        <td class="f_s_14 f_w_400 color_text_2">$564</td>
                ...
                <div class="white_card card_height_100 mb_20 ">
                    ...
                    <div class="white_card_body QA_section">
                        <div class="QA_table ">
                            ...
                            <table class="table lms_table_active2 p-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_62 mr_15 mt-0"><img
                                                        class="img-fluid radius_50"
                                                        src="assets/admin/img/customers/pro_big.png" alt></div>
                                        ...
                                        <td class="f_s_14 f_w_400 text-end"><a href="assets/admin/#" class="badge_btn_1">354
                                                sold</a></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_62 mr_15 mt-0"><img
                                                        class="img-fluid radius_50"
                                                        src="assets/admin/img/customers/pro_big_1.png" alt></div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="customer d-flex align-items-center">
                                                <div class="thumb_62 mr_15 mt-0"><img
                                                        class="img-fluid radius_50"
                                                        src="assets/admin/img/customers/pro_big_2.png" alt></div>
                            ...
                            <a href="assets/admin/#" class="badge_btn_semi mt_30 ml_15">View All</a>
                        </div>
                    </div>
                </div>
            </div>
