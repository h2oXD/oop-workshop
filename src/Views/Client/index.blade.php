                ...
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card">
                        <div class="post-slider slider-sm">
                            <img src="{{ assetClient('images/post/post-1.jpg') }}" class="card-img-top" alt="post-thumb">
                        </div>

                        <div class="card-body">
                            <h3 class="h4 mb-3"><a class="post-title" href="{{ url('detail') }}">Use apples to give your
                                    bakes caramel
                                    and a moist texture</a></h3>
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="author-single.html" class="card-meta-author">
                                        <img src="{{ assetClient('images/john-doe.jpg') }}">
                            ...
                            <a href="{{ url('detail') }}" class="btn btn-outline-primary">Read More</a>
                        </div>
                    </article>
                </div>
                <div class="col-lg-4 mb-5">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            <article class="card mb-4">
                                ...
                                <div class="card-body">
                                    <h3 class="h4 mb-3"><a class="post-title" href="post/elements/">Elements That You Can
                                            Use In This.</a></h3>
                                    <ul class="card-meta list-inline">
                                        <li class="list-inline-item">
                                            <a href="author-single.html" class="card-meta-author">
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <article class="card mb-4">
                                ...
                                <div class="card-body">
                                    <h3 class="h4 mb-3"><a class="post-title" href="post-details.html">Advice From a
                                            Twenty Something</a></h3>
                                    <ul class="card-meta list-inline">
                                        <li class="list-inline-item">
                                            <a href="author-single.html" class="card-meta-author">
                            ...
                            <article class="card mb-4">
                                <div class="card-body">
                                    <h3 class="h4 mb-3"><a class="post-title" href="post-details.html">How To Make
                                            Cupcakes and Cashmere Recipe At Home</a></h3>
                                    <ul class="card-meta list-inline">
                                        <li class="list-inline-item">
                                            <a href="author-single.html" class="card-meta-author">
                                                <img src="images/kate-stone.jpg" alt="Kate Stone">
